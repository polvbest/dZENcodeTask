$(document).ready(function() {
    ...
    var editorConfig = {
      path_absolute: '/',
      selector: "textarea",
      plugins: 'image code link linkchecker paste image preview ',
      menubar: false,
      toolbar: 'undo redo | unlink link image | bold italic code | pastetext preview | myInsertFile ',
      valid_elements: "@[id|class|title|style|data-options|data*],#p,br,-b,hr",
      extended_valid_elements : "a[name|href|target|title|onclick],img[class|src|border=0|alt|title|width=320|height=240|align|name],span[class|align|style]",
